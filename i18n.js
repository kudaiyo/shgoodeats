const translations = {
  zh: {
    ...
    tabInstr: '食用说明',
    tabAuthors: '关于作者',
    ratingExplainer: '<div class="rating-scale"><div class="rating-scale-row"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><span>一口惊艳</span></div><div class="rating-scale-row"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><span>常常想念</span></div><div class="rating-scale-row"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><span>百吃不厌</span></div></div>',
  ...
  en: {
    ...
    tabInstr: 'How to Use',
    tabAuthors: 'About',
    ratingExplainer: '<div class="rating-scale"><div class="rating-scale-row"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><span>First bite wow</span></div><div class="rating-scale-row"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><span>Always on my mind</span></div><div class="rating-scale-row"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><img src="rating-icon.png" class="rating-explainer-icon" alt="🐉"><span>Could eat forever</span></div></div>',
